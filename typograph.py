...
class Typograph:
    ...
    def _preprocess(self, image, target_size, clip_limit, use_clahe, rescale_intensity, background_glyph):
        """
    ...
    def image_to_text(self, image, max_size=(80, 60), cutoff=0.3, resize_mode=Image.LANCZOS, clip_limit=0.02,
        ...
        :type image: :class:`~PIL.Image.Image`
        :param max_size: output size for glyph version of image.
        Given as total number of glyphs to be used across and down
        ...
        preprocessed_image = self._preprocess(image=image, target_size=target_size, clip_limit=clip_limit,
                                              use_clahe=use_clahe, rescale_intensity=rescale_intensity,
